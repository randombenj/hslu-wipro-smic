...
const useDrawAxis = (xText: string, yText: string, svgRef: Svg, scales: Scales | null, height: number, width: number, margin: Margin) => {
    useEffect(() => {
        if (scales) {
...
const useDrawLabels = (svgRef: Svg, scales: Scales | null, height: number) => {
    const ray = [
